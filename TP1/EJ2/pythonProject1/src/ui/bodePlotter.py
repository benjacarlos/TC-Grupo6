...
class Ui_bodePlotterWindow(object):
    def setupUi(self, bodePlotterWindow):
        ...
        self.transferFunctionAction.setGeometry(QtCore.QRect(20, 40, 139, 71))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.saveTransferFunction.setGeometry(QtCore.QRect(20, 110, 75, 23))
        ...
        self.returnTransferFunction.setGeometry(QtCore.QRect(100, 110, 75, 23))
        ...
        self.spiceAction.setGeometry(QtCore.QRect(20, 32, 139, 71))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.csvFunction.setGeometry(QtCore.QRect(30, 450, 181, 161))
        ...
        self.csvAction.setGeometry(QtCore.QRect(20, 30, 139, 81))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.csvFunctionMsg.setGeometry(QtCore.QRect(0, 20, 181, 16))
        font = QtGui.QFont()
        font.setPointSize(7)
        ...
        self.saveCsvFunction.setGeometry(QtCore.QRect(10, 120, 75, 23))
        self.saveCsvFunction.setObjectName("saveCsvFunction")
        self.returnCsvFunction = QtWidgets.QPushButton(self.csvInput)
        self.returnCsvFunction.setGeometry(QtCore.QRect(100, 120, 75, 23))
