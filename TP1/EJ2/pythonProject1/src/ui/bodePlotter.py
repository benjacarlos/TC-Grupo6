...
class Ui_bodePlotterWindow(object):
    def setupUi(self, bodePlotterWindow):
        ...
        self.transferFunctionMsg.setGeometry(QtCore.QRect(20, 10, 191, 20))
        ...
        self.csvFunctionMsg.setGeometry(QtCore.QRect(0, 30, 191, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def retranslateUi(self, bodePlotterWindow):
        ...
        self.transferFunctionMsg.setText(_translate("bodePlotterWindow", "Ingrese la Función de Transferencia"))
