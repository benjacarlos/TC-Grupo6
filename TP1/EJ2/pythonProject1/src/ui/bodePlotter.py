...
class Ui_bodePlotterWindow(object):
    def setupUi(self, bodePlotterWindow):
        ...
        bodePlotterWindow.resize(1158, 915)
        ...
        self.removePlotsAction.setGeometry(QtCore.QRect(950, 140, 181, 111))
        ...
        self.signalResponse.setGeometry(QtCore.QRect(30, 630, 211, 221))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(50, 10, 111, 205))
        ...
        self.returnImpulseSignal.setGeometry(QtCore.QRect(110, 170, 93, 28))
        ...
        self.impulseAmplitudeLabel.setGeometry(QtCore.QRect(40, 60, 50, 16))
        ...
        self.saveImpulseSignal.setGeometry(QtCore.QRect(10, 170, 93, 28))
        ...
        self.impulseAmplitudeInput.setGeometry(QtCore.QRect(110, 50, 62, 24))
        ...
        self.impulseFinalTimeInput = QtWidgets.QDoubleSpinBox(self.impulseSignalInput)
        self.impulseFinalTimeInput.setGeometry(QtCore.QRect(110, 120, 62, 24))
        self.impulseFinalTimeInput.setDecimals(12)
        ...
        self.impulseFinalTimeLabel = QtWidgets.QLabel(self.impulseSignalInput)
        self.impulseFinalTimeLabel.setGeometry(QtCore.QRect(22, 120, 81, 20))
        ...
        self.returnStepSignal.setGeometry(QtCore.QRect(110, 170, 93, 28))
        ...
        self.saveStepSignal.setGeometry(QtCore.QRect(10, 170, 93, 28))
        self.saveStepSignal.setObjectName("saveStepSignal")
        self.stepFinalTimeLabel = QtWidgets.QLabel(self.stepSignalInput)
        self.stepFinalTimeLabel.setGeometry(QtCore.QRect(42, 120, 81, 20))
        self.stepFinalTimeLabel.setObjectName("stepFinalTimeLabel")
        self.stepFinalTimeInput = QtWidgets.QDoubleSpinBox(self.stepSignalInput)
        self.stepFinalTimeInput.setGeometry(QtCore.QRect(130, 120, 62, 24))
        self.stepFinalTimeInput.setDecimals(12)
        ...
        self.sineFrequencyInput.setDecimals(12)
        ...
        self.saveSineSignal.setGeometry(QtCore.QRect(0, 180, 93, 28))
        self.saveSineSignal.setObjectName("saveSineSignal")
        self.returnSineSignal = QtWidgets.QPushButton(self.sineSignalInput)
        self.returnSineSignal.setGeometry(QtCore.QRect(100, 180, 93, 28))
        ...
        self.sineFinalTimeLabel = QtWidgets.QLabel(self.sineSignalInput)
        self.sineFinalTimeLabel.setGeometry(QtCore.QRect(22, 140, 81, 20))
        self.sineFinalTimeLabel.setObjectName("sineFinalTimeLabel")
        self.sineFinalTimeInput = QtWidgets.QDoubleSpinBox(self.sineSignalInput)
        self.sineFinalTimeInput.setGeometry(QtCore.QRect(110, 140, 62, 24))
        self.sineFinalTimeInput.setDecimals(12)
        ...
        self.squareFrequencyInput.setDecimals(12)
        ...
        self.saveSquareSignal.setGeometry(QtCore.QRect(10, 190, 93, 28))
        self.saveSquareSignal.setObjectName("saveSquareSignal")
        self.returnSquareSignal = QtWidgets.QPushButton(self.squareSignalInput)
        self.returnSquareSignal.setGeometry(QtCore.QRect(110, 190, 93, 28))
        ...
        self.squareFinalTimeLabel = QtWidgets.QLabel(self.squareSignalInput)
        self.squareFinalTimeLabel.setGeometry(QtCore.QRect(22, 150, 81, 20))
        self.squareFinalTimeLabel.setObjectName("squareFinalTimeLabel")
        self.squareFinalTimeInput = QtWidgets.QDoubleSpinBox(self.squareSignalInput)
        self.squareFinalTimeInput.setGeometry(QtCore.QRect(110, 150, 62, 24))
        self.squareFinalTimeInput.setDecimals(12)
        ...
        self.triangleFrequencyInput.setDecimals(12)
        ...
        self.saveTriangleSignal.setGeometry(QtCore.QRect(10, 190, 93, 28))
        ...
        self.returnTriangleSignal.setGeometry(QtCore.QRect(110, 190, 93, 28))
        ...
        self.triangleFinalTimeLabel = QtWidgets.QLabel(self.triangleSignalInput)
        self.triangleFinalTimeLabel.setGeometry(QtCore.QRect(22, 140, 81, 20))
        self.triangleFinalTimeLabel.setObjectName("triangleFinalTimeLabel")
        self.triangleFinalTimeInput = QtWidgets.QDoubleSpinBox(self.triangleSignalInput)
        self.triangleFinalTimeInput.setGeometry(QtCore.QRect(110, 140, 62, 24))
        self.triangleFinalTimeInput.setDecimals(12)
        ...
        self.signalResponseCheckBox.setGeometry(QtCore.QRect(100, 860, 70, 17))
    ...
    def retranslateUi(self, bodePlotterWindow):
        ...
        self.impulseFinalTimeInput.setSuffix(_translate("bodePlotterWindow", "s"))
        ...
        self.stepFinalTimeInput.setSuffix(_translate("bodePlotterWindow", "s"))
        ...
        self.sineFinalTimeInput.setSuffix(_translate("bodePlotterWindow", "s"))
        ...
        self.squareFinalTimeInput.setSuffix(_translate("bodePlotterWindow", "s"))
        ...
        self.triangleSymetryLabel.setText(_translate("bodePlotterWindow", "Simetría (%)"))
        ...
        self.triangleFinalTimeInput.setSuffix(_translate("bodePlotterWindow", "s"))
