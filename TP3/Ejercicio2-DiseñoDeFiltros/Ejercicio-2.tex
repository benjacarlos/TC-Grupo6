...
\begin{itemize}
	\item Ganancia mayor a -3 dB cuando $f < 5 KHz$ 
	\item Ganancia menor a -10 dB cuando $f > 17.5 KHz $
	\item Ganancia nunca superior a 0 dB
	\item Ganancia unitaria en continua ($f \to \infty$)
\end{itemize}
...
$$H(S)=\frac{V_out(S)}{V_in(S)}=\frac{\frac{1}{SC}}{SL+R+\frac{1}{SC}} \longrightarrow 
...
Sabiendo que los sobrepicos se presentarán en casos donde $\xi \geq \frac{1}{\sqrt{2}}$, se tomarán valores que cumplan la relación:

$$\xi > \frac{1}{\sqrt{2}}$$

Luego en nuestro caso, analizando las especificaciones 
...
mayores o menores dependiendo de los componentes elegidos, entonces nuestro equivalente quedará representado por:
