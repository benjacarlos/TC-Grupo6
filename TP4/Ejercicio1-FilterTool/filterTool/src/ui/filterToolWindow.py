...
class Ui_filterToolWindow(object):
    def setupUi(self, filterToolWindow):
        ...
        self.stages.setGeometry(QtCore.QRect(10, 10, 901, 721))
        ...
        self.widget = filterToolPlot(self.stageOne)
        self.widget.setGeometry(QtCore.QRect(330, 30, 551, 381))
    ...
    def retranslateUi(self, filterToolWindow):
        ...
        self.acceptParametersStageOne.setText(_translate("filterToolWindow", "Accept Parameters"))
