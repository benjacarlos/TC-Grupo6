...
class Ui_filterToolWindow(object):
    def setupUi(self, filterToolWindow):
        ...
        self.plotAllSos_2 = QtWidgets.QCheckBox(self.yesPlot)
        self.plotAllSos_2.setGeometry(QtCore.QRect(10, 30, 61, 21))
        self.plotAllSos_2.setObjectName("plotAllSos_2")
    ...
    def retranslateUi(self, filterToolWindow):
        ...
        self.plotAllSos_2.setText(_translate("filterToolWindow", "Template"))
