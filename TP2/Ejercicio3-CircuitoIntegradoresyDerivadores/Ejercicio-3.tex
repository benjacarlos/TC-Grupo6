...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../Ejercicio3-CircuitoIntegradoresyDerivadores/Imagenes/circuito-derivador.png}
...
\subsubsection{Análisis de Entrada Senoidal al circuito}
